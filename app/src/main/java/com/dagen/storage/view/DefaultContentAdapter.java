...
public class DefaultContentAdapter extends ArrayAdapter<List<String>> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (lv_content.isItemChecked(position)){
            view.setBackgroundColor(getContext().getResources().getColor(R.color.color_478DFE));
        } else {
            view.setBackgroundColor(getContext().getResources().getColor(R.color.color_999999));
        }
