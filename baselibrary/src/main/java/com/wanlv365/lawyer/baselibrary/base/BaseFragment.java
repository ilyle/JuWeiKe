...
public abstract class BaseFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(mProgressDilog==null) {
            mProgressDilog = new LoadProgressDialog(getActivity(), "加载中");
        }
        if(gson==null){
            gson=new Gson();
        }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        helper = new StatusManager.Builder(getActivity(),getLayoutView()).build();
        ...
        helper = new StatusManager.Builder(getActivity(),getLayoutView())
                .setEmptyView(new MyEmptyView(getActivity())).
                        build();
